...
from Project import utils, utils_graph
import numpy as np
...
from Project.utils import compute_backbone_shapes
            ...
            try:
                ...
                if dataset.image_info[image_id]['source'] in no_augmentation_sources:
                    image, image_meta, gt_class_ids, gt_boxes, gt_masks = \
                        load_image_gt(dataset, config, image_id, augmentation=None)
                else:
                    image, image_meta, gt_class_ids, gt_boxes, gt_masks = \
...
def generate_dataset(dataset, config, shuffle=True, augment=False, augmentation=None,
                     random_rois=0, batch_size=1, detection_targets=False,
                     no_augmentation_sources=None):
