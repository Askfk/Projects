...
public class PowerfulLayout1 extends RelativeLayout {
    // 屏幕宽高
    ...
    public PowerfulLayout1(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public PowerfulLayout1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PowerfulLayout1(Context context) {
        super(context);
        init(context);
    }
    ...
    public class ScaleGestureListener implements
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            if (scale>0.5&&scale<5) {
                ViewHelper.setScaleX(PowerfulLayout1.this, scale);// x方向上缩放
                ViewHelper.setScaleY(PowerfulLayout1.this, scale);// y方向上缩放
            }
            return false;
        }
