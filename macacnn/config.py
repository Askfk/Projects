...
class Config(object):
    ...
    LOSS_WEIGHTS = {
        "mask_rpn_class_loss": 0.5,
        "caption_rpn_class_loss": 0.5,
        "mask_rpn_bbox_loss": 0.5,
        "caption_rpn_bbox_loss": 0.5,
        "macacnn_bbox_loss": 1.,
        "macarcnn_bbox_score_loss": 1.,
    ...
    EMBEDDING_DIM = 256
    UNITS = 512
    VOCAB_SIZE = 5000 + 1  # 5000 contains the dictionary and <start> <end> tokens, 1 stands for <pad>
    MAX_LENGTH = 12
