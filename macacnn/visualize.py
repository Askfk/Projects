...
def display_instances(image, bboxes, captions, masks, title='', ax=None, colors=None, figsize=(16, 16),
    ...
    if show_mask:
        colors = colors or random_colors(masks.shape[2])
...
def display_top_masks(image, mask, class_ids=None, class_names=None, limit=4):
    ...
    for i in range(limit):
        ...
        m = np.sum(mask * np.arange(1, mask.shape[-1] + 1), -1)
        to_display.append(m)
