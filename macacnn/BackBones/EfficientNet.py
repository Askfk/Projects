...
from macacnn.BackBones.weights import IMAGENET_WEIGHTS_PATH, IMAGENET_WEIGHTS_HASHES, NS_WEIGHTS_HASHES, NS_WEIGHTS_PATH
...
if __name__ == "__main__":
    ...
    efficientnet = EfficientNetX(Config)
    inputs = tf.keras.layers.Input([None, None, 3])
    efficientnet = efficientnet.build_model(inputs)
    b = efficientnet.outputs
